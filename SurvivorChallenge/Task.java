...
public abstract class Task {
    ...
    /**
     * Returns a list of actions that may be attempted to complete a task.
     * 
     * Pre-conditions: None
     * Post-conditions: Returns a List of Strings containing the options: "jump",
     *                  "run", "swim", "crawl", and "climb" 
     *
